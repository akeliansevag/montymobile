...
<section class="py-5 bg-white">
    <div class="container">
        ...
        <!-- <div class="boxed text-start">
            <img src="<?= get_template_directory_uri() ?>/assets/img/esim/icon-2.webp" alt="Icon 2">
            <h2>eSIM Transfer</h2>
        ...
        <div class="boxed text-start">
            <img src="<?= get_template_directory_uri() ?>/assets/img/esim/icon-3.webp" alt="Icon 3">
