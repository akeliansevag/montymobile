...
<section class="sign-up-section">
    <div class="sign-up-one">
        ...
        <div class="sign-up-content">
            ...
            <p>
                Monty Communication Platform is an all-in-one Omnichannel Solution offering 20+ channels, with top-tier security and advanced customer engagement tools to help you orchestrate an unforgettable customer experience and boost your revenues within your existing system.
            </p>
            <ul>
                <li>
                    <span>
                ...
                <li>
                    ...
                    <span>Centralize your communications & Automate workflows.</span>
                </li>
                <li>
                    <span>
                        <svg id="checked" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                    ...
                    <span>Engage customers with real-time notifications.</span>
                </li>
                <li>
                    <span>
                        <svg id="checked" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
