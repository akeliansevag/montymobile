      ...
      <div class="row">
          ...
          <div class="col-xxl-8">
                    <div class="post-wrapper mb-5">
                      <a class="back-to" href="<?=get_permalink( get_page_by_path( 'blog' ) )?>"><svg width="30px" height="30px" viewBox="0 0 30 30" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <div class="post-image mt-5">
                        <?php $thumbnail = get_the_post_thumbnail_url($post->ID,"banner-image"); ?>
